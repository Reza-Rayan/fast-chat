...
const validationSchema = Yup.object({
  ...
  email: Yup.string()
    ...
    .required("REmail is required"),
  password: Yup.string()
    .required("Password isequired")
      ...
      <div className="container mx-auto grid grid-cols-7">
        <div className="col-span-4 flex flex-col justify-center">
          <form
            ...
            className="mt-4 bg-white py-6 px-4 shadow-lg rounded-lg"
          >
            ...
            <div className="mb-3">
              <div className="signup-profile-pic__container">
                ...
                <label htmlFor="image-upload" className="image-upload-label">
                  <AddPhotoAlternate
                    width={14}
                    className="absolute top-0 text-white bg-indigo-600 p-1 rounded-full cursor-pointer shadow-lg"
                  />
                </label>
                <input
                  type="file"
            ...
            <div className="mb-3">
              <label htmlFor="email" className="mb-[-20px]">
                Email:
              </label>
              <TextField
                fullWidth
            ...
            <label htmlFor="password" className="mb-[-20px]">
              Password:
            </label>
            <TextField
              fullWidth
